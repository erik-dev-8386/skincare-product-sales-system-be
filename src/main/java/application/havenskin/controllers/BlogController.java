...
//    }
    ...
    public Blogs updateBlogById(@PathVariable String blogTitle,@RequestPart("blogs") Blogs blog, @RequestParam("images") List<MultipartFile> images) throws IOException {
